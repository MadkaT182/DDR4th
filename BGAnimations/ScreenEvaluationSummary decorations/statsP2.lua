...
local Ng = string.format("% 5d",STATSMAN:GetAccumPlayedStageStats():GetPlayerStageStats(PLAYER_2):GetHoldNoteScores("HoldNoteScore_LetGo"));
local Boo = string.format("% 5d",STATSMAN:GetAccumPlayedStageStats():GetPlayerStageStats(PLAYER_2):GetTapNoteScores("TapNoteScore_Miss"));
